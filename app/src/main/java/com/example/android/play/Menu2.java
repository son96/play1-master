    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent i=new Intent(getContext(),ViewChildrenParent.class);
...
//                Log.w("pid",Config.TUSERNAME);
                ...
                employees.put(Config.TAG_KEY_PUSERNAME, Config.PUSERNAME);
                //  employees.put(Config.TAG_NAME, name)
                String s = rh.sendPostRequest(Config.URL_CHILDREN_PARENT,employees);
                return s;
            }
        }
