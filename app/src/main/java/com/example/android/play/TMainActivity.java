    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.add_children:
                fragment=new AddChildren();
                break;
            case R.id.view_children:
                fragment = new ViewChildren();
                break;
            case R.id.Tlogout:
//                fragment = new Menu6();
                logout();
        ...
        if (fragment != null) {
            ...
            ft.replace(R.id.content_tframe, fragment);
            ft.commit();
        }
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(TMainActivity.this, LoginDecider.class);
